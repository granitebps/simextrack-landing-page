    ...
    <div className="container max-w-4xl py-10 px-6 md:px-10 lg:px-16">
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-2 text-muted-foreground">Last updated: May 3, 2025</p>
        ...
        <div className="space-y-6">
          ...
          <h2 className="text-xl font-bold tracking-tighter sm:text-2xl md:text-3xl">Interpretation</h2>
          <p className="mt-2 text-muted-foreground">
            The words of which the initial letter is capitalized have meanings defined under the following conditions.
            The following definitions shall have the same meaning regardless of whether they appear in singular or in
            plural.
          </p>
          <h2 className="text-xl font-bold tracking-tighter sm:text-2xl md:text-3xl">Definitions</h2>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li className="text-muted-foreground">
              <p>
                ...
                electronic device, named SIMEXTRACK
              </p>
            </li>
            <li className="text-muted-foreground">
              <p>
                <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                or &quot;Our&quot; in this Agreement) refers to SIMEXTRACK.
              </p>
            </li>
            <li className="text-muted-foreground">
              <p>
          ...
          <h2 className="text-xl font-bold tracking-tighter sm:text-2xl md:text-3xl">Types of Data Collected</h2>
          <h3 className="text-lg font-bold tracking-tighter sm:text-xl md:text-2xl">Personal Data</h3>
          ...
          <h3 className="text-lg font-bold tracking-tighter sm:text-xl md:text-2xl">Usage Data</h3>
          <p className="text-muted-foreground">Usage Data is collected automatically when using the Service.</p>
          <p className="text-muted-foreground">
          ...
          <h2 className="text-xl font-bold tracking-tighter sm:text-2xl md:text-3xl">Use of Your Personal Data</h2>
          ...
          <h2 className="text-xl font-bold tracking-tighter sm:text-2xl md:text-3xl">Transfer of Your Personal Data</h2>
          <p className="text-muted-foreground">
          ...
          <h3 className="text-lg font-bold tracking-tighter sm:text-xl md:text-2xl">Business Transactions</h3>
          <p className="text-muted-foreground">
          ...
          <h3 className="text-lg font-bold tracking-tighter sm:text-xl md:text-2xl">Law enforcement</h3>
          <p className="text-muted-foreground">
          ...
          <h3 className="text-lg font-bold tracking-tighter sm:text-xl md:text-2xl">Other legal requirements</h3>
          <p className="text-muted-foreground">
            The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li className="text-muted-foreground">Comply with a legal obligation</li>
            <li className="text-muted-foreground">Protect and defend the rights or property of the Company</li>
            <li className="text-muted-foreground">
              Prevent or investigate possible wrongdoing in connection with the Service
            </li>
            <li className="text-muted-foreground">Protect the personal safety of Users of the Service or the public</li>
            <li className="text-muted-foreground">Protect against legal liability</li>
          </ul>
          <h2 className="text-xl font-bold tracking-tighter sm:text-2xl md:text-3xl">Security of Your Personal Data</h2>
          <p className="text-muted-foreground">
          ...
          <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Children's Privacy</h1>
          <p className="text-muted-foreground">
          ...
          <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Links to Other Websites</h1>
          <p className="text-muted-foreground">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li className="text-muted-foreground">
              <p>By email: info@granitebps.com</p>
            </li>
            <li className="text-muted-foreground">
              <p>
                By visiting this page on our website:{" "}
                <a href="https://granitebps.com/contact" rel="external nofollow noopener" target="_blank">
                  https://granitebps.com/contact
                </a>
              </p>
            </li>
          </ul>
