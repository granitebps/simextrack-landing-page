  ...
  return (
    <div className="container max-w-4xl py-10 px-6 md:px-10 lg:px-16">
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-6">
          <h1 className="text-2xl font-bold tracking-tighter sm:text-3xl md:text-4xl">Terms &amp; Conditions</h1>
          <p className="mt-2 text-muted-foreground">
            ...
            property rights related to it, still belong to GBPS.
          </p>
          <p className="text-muted-foreground">
            GBPS is committed to ensuring that the app is as useful and efficient as possible. For that reason, we
          ...
          <p className="text-muted-foreground">
            The SIMEXTRACK app stores and processes personal data that you have provided to us, to provide my Service.
            ...
            SIMEXTRACK app won’t work properly or at all.
          </p>
          ...
          <p className="text-muted-foreground">
            You should be aware that there are certain things that GBPS will not take responsibility for. Certain
            functions of the app will require the app to have an active internet connection. The connection can be Wi-Fi
            or provided by your mobile network provider, but GBPS cannot take responsibility for the app not working at
          ...
          <p className="text-muted-foreground">
            Along the same lines, GBPS cannot always take responsibility for the way you use the app i.e. You need to
            make sure that your device stays charged – if it runs out of battery and you can’t turn it on to avail the
            Service, GBPS cannot accept responsibility.
          </p>
          <p className="text-muted-foreground">
            With respect to GBPS’s responsibility for your use of the app, when you’re using the app, it’s important to
            bear in mind that although we endeavor to ensure that it is updated and correct at all times, we do rely on
            third parties to provide information to us so that we can make it available to you. GBPS accepts no
          ...
          <p className="text-muted-foreground">
            ...
            change, and you’ll need to download the updates if you want to keep using the app. GBPS does not promise
          ...
          <p className="text-muted-foreground">These terms and conditions are effective as of 2025-05-03</p>
